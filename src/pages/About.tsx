          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                КапРемонт Минск - ведущая организация в сфере капитального ремонта многоквартирных домов в столице Беларуси. С момента основания в 2008 году мы успешно реализовали более 200 проектов различной сложности.
              </p>
              <p className="text-muted-foreground mb-4">
